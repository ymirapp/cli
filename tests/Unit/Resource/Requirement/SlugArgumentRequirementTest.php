...
use Ymir\Cli\Resource\Requirement\SlugArgumentRequirement;
use Ymir\Cli\Tests\TestCase;

class SlugArgumentRequirementTest extends TestCase
{
    public function testFulfillAsksQuestionIfArgumentDoesNotExist(): void
    {
        ...
        $requirement = new SlugArgumentRequirement('arg', 'Question?', 'default');
    ...
    public function testFulfillReturnsArgumentFromInput(): void
    {
        ...
        $requirement = new SlugArgumentRequirement('arg', 'Question?');
