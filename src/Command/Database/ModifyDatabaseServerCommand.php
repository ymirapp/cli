...
class ModifyDatabaseServerCommand extends AbstractDatabaseCommand
{
    ...
    {
        $database = $this->determineDatabaseServer('Which database server would you like to modify?', $input, $output);
     ...
     */
    private function determineStorage(InputInterface $input, OutputStyle $output, int $storage): int
    {
     ...
     */
    private function determineType(InputInterface $input, OutputStyle $output, int $providerId, string $type): string
    {
