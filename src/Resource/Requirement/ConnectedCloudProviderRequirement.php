...
class ConnectedCloudProviderRequirement extends CloudProviderRequirement
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return parent::fulfill($context, array_merge($fulfilledRequirements, ['status' => 'connected']));
    }
}
